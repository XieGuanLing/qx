...
public class DateUtil {
    ...
    public static final String DATE_TIME_FORMAT_PATTERN_EXAMPLE = "2016-08-26 17:11:00";

    public static final String DATE_FORMAT_PATTERN_EXAMPLE = "2016/08/26";
    ...
    public static Date tryParseDateTime(String dateTime) {
        try {
            ...
            try {
                return SQL_DATE_EX_FORMAT.parse(dateTime);
    ...
    public static String format2MonthDate(Date date) {
        if (date != null)
    ...
    public static java.sql.Date parseSqlDate(String dateValueStr) {
        ...
        if (date == null) {
            try {
                return new java.sql.Date(SQL_DATE_EX_FORMAT.parse(dateValueStr)
                        .getTime());
            } catch (Exception e) {
                //ignore
            }
